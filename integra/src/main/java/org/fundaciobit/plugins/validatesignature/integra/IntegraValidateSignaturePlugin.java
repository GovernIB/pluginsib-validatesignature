 ...
 *
 */
public class IntegraValidateSignaturePlugin extends AbstractValidateSignaturePlugin
		implements IValidateSignaturePlugin {

	public static final String INTEGRA_BASE_PROPERTIES = VALIDATE_SIGNATURE_BASE_PROPERTY + "integra.";
	public static final String URL_BASE_PROPERTY = INTEGRA_BASE_PROPERTIES + "url";
	public static final String DEBUG_BASE_PROPERTY = INTEGRA_BASE_PROPERTIES + "debug";
	...
	static {
		...
		localSignType2PluginSignType.put(FORMAT_CADES_XL1, ValidateSignatureResponse.SIGNTYPE_CAdES);
		localSignType2PluginSignType.put(FORMAT_CADES_XL2, ValidateSignatureResponse.SIGNTYPE_CAdES);
		localSignType2PluginSignType.put(FORMAT_CADES_X1, ValidateSignatureResponse.SIGNTYPE_CAdES);
		localSignType2PluginSignType.put(FORMAT_CADES_X2, ValidateSignatureResponse.SIGNTYPE_CAdES);
		...
		localSignType2PluginSignType.put(FORMAT_CADES_EPES, ValidateSignatureResponse.SIGNTYPE_CAdES);
		localSignType2PluginSignType.put(FORMAT_CADES_BES, ValidateSignatureResponse.SIGNTYPE_CAdES);
		localSignType2PluginSignType.put(FORMAT_XADES_A, ValidateSignatureResponse.SIGNTYPE_XAdES);
		localSignType2PluginSignType.put(FORMAT_XADES_XL1, ValidateSignatureResponse.SIGNTYPE_XAdES);
		localSignType2PluginSignType.put(FORMAT_XADES_XL2, ValidateSignatureResponse.SIGNTYPE_XAdES);
		localSignType2PluginSignType.put(FORMAT_XADES_X1, ValidateSignatureResponse.SIGNTYPE_XAdES);
		localSignType2PluginSignType.put(FORMAT_XADES_X2, ValidateSignatureResponse.SIGNTYPE_XAdES);
		...
		localSignType2PluginSignType.put(FORMAT_XADES_EPES, ValidateSignatureResponse.SIGNTYPE_XAdES);
		localSignType2PluginSignType.put(FORMAT_XADES_BES, ValidateSignatureResponse.SIGNTYPE_XAdES);
		localSignType2PluginSignType.put(FORMAT_PDF, ValidateSignatureResponse.SIGNTYPE_PDF);
		localSignType2PluginSignType.put(FORMAT_PADES_BASIC, ValidateSignatureResponse.SIGNTYPE_PAdES);
		localSignType2PluginSignType.put(FORMAT_PADES_BES, ValidateSignatureResponse.SIGNTYPE_PAdES);
		localSignType2PluginSignType.put(FORMAT_PADES_EPES, ValidateSignatureResponse.SIGNTYPE_PAdES);
		localSignType2PluginSignType.put(FORMAT_PADES_LTV, ValidateSignatureResponse.SIGNTYPE_PAdES);

		localSignProfile2PluginSignProfile.put(FORMAT_CADES_A, ValidateSignatureResponse.SIGNPROFILE_A);
		localSignProfile2PluginSignProfile.put(FORMAT_CADES_XL1, ValidateSignatureResponse.SIGNPROFILE_XL1);
		localSignProfile2PluginSignProfile.put(FORMAT_CADES_XL2, ValidateSignatureResponse.SIGNPROFILE_XL2);
		localSignProfile2PluginSignProfile.put(FORMAT_CADES_X1, ValidateSignatureResponse.SIGNPROFILE_X1);
		localSignProfile2PluginSignProfile.put(FORMAT_CADES_X2, ValidateSignatureResponse.SIGNPROFILE_X2);
		localSignProfile2PluginSignProfile.put(FORMAT_CADES_C, ValidateSignatureResponse.SIGNPROFILE_C);
		localSignProfile2PluginSignProfile.put(FORMAT_CADES_T, ValidateSignatureResponse.SIGNPROFILE_T);
		localSignProfile2PluginSignProfile.put(FORMAT_CADES_EPES, ValidateSignatureResponse.SIGNPROFILE_EPES);
		localSignProfile2PluginSignProfile.put(FORMAT_CADES_BES, ValidateSignatureResponse.SIGNPROFILE_BES);
		localSignProfile2PluginSignProfile.put(FORMAT_XADES_A, ValidateSignatureResponse.SIGNPROFILE_A);
		localSignProfile2PluginSignProfile.put(FORMAT_XADES_XL1, ValidateSignatureResponse.SIGNPROFILE_XL1);
		localSignProfile2PluginSignProfile.put(FORMAT_XADES_XL2, ValidateSignatureResponse.SIGNPROFILE_XL2);
		localSignProfile2PluginSignProfile.put(FORMAT_XADES_X1, ValidateSignatureResponse.SIGNPROFILE_X1);
		localSignProfile2PluginSignProfile.put(FORMAT_XADES_X2, ValidateSignatureResponse.SIGNPROFILE_X2);
		localSignProfile2PluginSignProfile.put(FORMAT_XADES_C, ValidateSignatureResponse.SIGNPROFILE_C);
		localSignProfile2PluginSignProfile.put(FORMAT_XADES_T, ValidateSignatureResponse.SIGNPROFILE_T);
		localSignProfile2PluginSignProfile.put(FORMAT_XADES_EPES, ValidateSignatureResponse.SIGNPROFILE_EPES);
		localSignProfile2PluginSignProfile.put(FORMAT_XADES_BES, ValidateSignatureResponse.SIGNPROFILE_BES);
		// TODO Posam BES
		localSignProfile2PluginSignProfile.put(FORMAT_PDF, ValidateSignatureResponse.SIGNPROFILE_BES);
		localSignProfile2PluginSignProfile.put(FORMAT_PADES_BASIC, ValidateSignatureResponse.SIGNPROFILE_PADES_BASIC);
		localSignProfile2PluginSignProfile.put(FORMAT_PADES_BES, ValidateSignatureResponse.SIGNPROFILE_BES);
		localSignProfile2PluginSignProfile.put(FORMAT_PADES_EPES, ValidateSignatureResponse.SIGNPROFILE_EPES);
		localSignProfile2PluginSignProfile.put(FORMAT_PADES_LTV, ValidateSignatureResponse.SIGNPROFILE_PADES_LTV);
	...
	public ValidateSignatureResponse validateSignature(ValidateSignatureRequest validationRequest) throws Exception {
		...
		String format = SignatureFormatDetector.getSignatureFormat(validationRequest.getSignatureData());
		...
		if (format == null || "UNRECOGNIZED".equals(format)) {
			...
			// TODO Això esta bé ja que només indica que el proces ha anat bé, no es
			// refereix
