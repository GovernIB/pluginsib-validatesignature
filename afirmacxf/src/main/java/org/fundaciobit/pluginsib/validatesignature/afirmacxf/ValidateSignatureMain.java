...
public class ValidateSignatureMain {
    ...
    public static void main(String[] args) {
        ...
        if (args.length != 3) {
            ...
            System.err.println(
                    "Example: validatesignature.bat plugin.properties org.fundaciobit.exemple.base. firma.pdf");
        ...
        try {
            ...
            System.err.println(
                    "No s'ha pogut llegir el fitxer de propietats '" + filePropertiesPathStr + "': " + e.getMessage());
            e.printStackTrace();
            System.exit(-1);
        }
